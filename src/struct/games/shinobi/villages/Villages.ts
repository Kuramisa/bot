...
export default [
    ...
    },
    {
        ...
        population: 0,
        icon: "https://static.wikia.nocookie.net/thenarutofanon/images/c/c9/Kumogakure_Symbol.svg/revision/latest/scale-to-width-down/300",
    },
    {
        id: "iwa",
        name: {
            en: "Hidden Stone Village",
            jp: "Iwagakure",
        },
        description:
        ...
        population: 0,
        icon: "https://static.wikia.nocookie.net/thenarutofanon/images/a/a5/Iwagakure_Symbol.svg/revision/latest/scale-to-width-down/300",
    },
    {
        id: "suna",
        name: {
            en: "Hidden Sand Village",
            jp: "Sunagakure",
        },
        description:
        ...
        population: 0,
        icon: "https://static.wikia.nocookie.net/thenarutofanon/images/1/18/Sunagakure_Symbol.svg/revision/latest/scale-to-width-down/300",
    },
    {
        id: "ame",
        name: {
            en: "Hidden Rain Village",
            jp: "Amegakure",
        },
        description:
        ...
        population: 0,
        icon: "https://static.wikia.nocookie.net/thenarutofanon/images/5/5b/Amegakure_Symbol.svg/revision/latest/scale-to-width-down/300",
    },
    {
        id: "kiri",
        name: {
            en: "Hidden Mist Village",
            jp: "Kirigakure",
        },
        description:
        ...
        population: 0,
        icon: "https://static.wikia.nocookie.net/thenarutofanon/images/e/e5/Kirigakure_Symbol.svg/revision/latest/scale-to-width-down/300",
    },
    {
        id: "uzushio",
        name: {
            en: "Hidden Eddy Village",
            jp: "Uzushiogakure",
        },
        description:
        ...
        population: 0,
        icon: "https://static.wikia.nocookie.net/thenarutofanon/images/0/06/Uzushiogakure_Symbol.svg/revision/latest/scale-to-width-down/300",
    },
] as ShinobiVillage[];
